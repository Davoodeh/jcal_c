...
/** Is the value in `NON_LEAP_CORRECTION` or no?
 *
 * Returns 1 if the year is the `non_leap_correction` list.
 */
int is_non_leap_correction(int p_year);

/** Return 0 if the year is not leap and 1 otherwise (results up to Y3K). */
// this matches every single year in the suggested wikipedia list in loops of 33
//
// 1210,
// 1214, 1218, 1222, 1226, 1230, 1234, 1238, 1243,
